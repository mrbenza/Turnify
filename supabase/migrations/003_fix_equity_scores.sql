-- Fix get_equity_scores: aggiunge filtro per mese/anno
-- p_month = 0 → tutti i tempi (per statistiche globali)
-- p_month > 0 → solo quel mese/anno
...
comment on function get_equity_scores is
  'Score equità turni: score basso = priorità alta. p_month=0 → tutti i tempi.';
