      ...
      <table className="w-full text-sm" aria-label="Storico turni assegnati">
        <thead>
          <tr className="border-b border-gray-100">
            <th
              scope="col"
              className="text-left py-2 px-4 sm:px-0 font-semibold text-gray-500 text-xs uppercase tracking-wide"
            >
              Data
            </th>
            <th
              scope="col"
              className="text-left py-2 px-4 sm:px-2 font-semibold text-gray-500 text-xs uppercase tracking-wide"
            >
              Tipo
            </th>
            <th
          ...
          {turni.map((turno) => {
            ...
            return (
              <tr key={turno.id} className="hover:bg-gray-50 transition-colors">
                <td className="py-2.5 px-4 sm:px-0 text-gray-700 whitespace-nowrap">
                  {formatDate(turno.date)}
                </td>
                <td className="py-2.5 px-4 sm:px-2 text-gray-600">
